...
public class TestingClass {
	...
	public static void main(String[] args) {
		...
		UnitType c1 = new UnitType("crusader","crusader","castle",10,10,1);
		UnitType c2 = new UnitType("halberdier","halberdier","castle",10,10,5);
		UnitType c3 = new UnitType("pikeman","pikeman","castle",10,10,1);
		UnitType c4 = new UnitType("swordsman","swordsman","castle",10,10,1);
		...
		UnitType d4 = new UnitType("minotaurking","minotaurking","dungeon",10,10,1);
